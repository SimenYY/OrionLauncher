...
class MainWindow(QMainWindow):
    ...
    def _create_sidebar(self) -> QWidget:
        ...
        logo_label.setStyleSheet("color: #4CAF50; font-size: 24px; font-weight: bold; background: transparent;")
        ...
        self.user_info.setStyleSheet("color: #BBBBBB; font-size: 14px; background: transparent;")
