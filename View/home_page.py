...
class HomePage(QWidget):
    ...
    def __init__(self, game_controller: GameController, account_controller: AccountController, parent=None):
        """
        初始化首页
    ...
    def _init_ui(self):
        ...
        title_label.setStyleSheet("color: #4CAF50; font-size: 18px; font-weight: bold; background: transparent;")
        top_layout.addWidget(title_label)
        
        # 创建提示内容
        tip_label = QLabel("Getting a fresh tip for you...")
        tip_label.setStyleSheet("color: #BBBBBB; font-size: 14px; background: transparent;")
        ...
        self.version_info.setStyleSheet("color: #BBBBBB; font-size: 14px; background: transparent;")
    ...
    def _connect_signals(self):
        ...
        self.game_controller.game_launch_started.connect(self._handle_game_launch_started)
    ...
    def _handle_version_changed(self, index: int):
        ...
        if index >= 0:
            ...
            self.version_info.setText(f"{version_data['type'].capitalize()} - {version_data['id']}")
